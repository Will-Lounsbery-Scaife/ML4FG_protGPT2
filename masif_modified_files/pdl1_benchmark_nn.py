...
this cutoff are discarded. Recommended values: 1.7-2.2. 
...
print("")
print("pdb_dir: {}".format(pdb_dir))
print("precomp_dir: {}".format(precomp_dir))
print("ply_iface_dir: {}".format(ply_iface_dir))
print("desc_dir: {}".format(desc_dir))
print("iface_dir: {}".format(iface_dir))
print("surf_dir: {}".format(surf_dir))
print("")
...
target_name = "5dxw-ESM-3_A"
target_ppi_pair_id = "5dxw-ESM-3_A"
target_pdb_id = "5dxw-ESM-3_A"
target_chain = "A"
...
out_log = open("log_5dxw_3.txt", "w+")

# Go through every 9A patch in top_dir -- get the one with the highest iface mean 12A around it.

### print parameters ###
print("IFACE_CUTOFF: {}".format(IFACE_CUTOFF))
print("DESC_DIST_CUTOFF: {}".format(DESC_DIST_CUTOFF))
print("score_cutoff: {}".format(score_cutoff))
print("target_name: {}".format(target_name))
print("target_ppi_pair_id: {}".format(target_ppi_pair_id))
print("target_pdb_id: {}".format(target_pdb_id))
print("target_chain: {}".format(target_chain))
print("target_ply_fn: {}".format(target_ply_fn))
print("")
###

out_log.write("Target name: {}\n".format(target_name))
out_log.write("IFACE_CUTOFF: {}\n".format(IFACE_CUTOFF))
out_log.write("DESC_DIST_CUTOFF: {}\n".format(DESC_DIST_CUTOFF))
out_log.write("score_cutoff: {}\n\n".format(score_cutoff))
...
target_struct = parser.get_structure(
    ...
    "{}".format(target_pdb_id),
    os.path.join(target_pdb_dir, "{}.pdb".format(target_pdb_id)),
)
...
print("")
print("Number of matches: {}".format(num_matched))
...
#    continue
    ...
    # Filter anything above score_cutoff
    top_scorers = np.where(scores > score_cutoff)[0]
